...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::update_journal_entry_safe,
            ...
            commands::list_ml_reference_examples,
            commands::upsert_ml_reference_examples,
            commands::clear_ml_reference_examples,
            ...
            commands::save_french_tax_report,
            commands::get_french_tax_report,
            commands::list_french_tax_report_years,
            commands::delete_french_tax_report,
            ...
            dprice_commands::dprice_get_prices,
