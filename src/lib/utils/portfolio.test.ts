...
describe("computePortfolioReport", () => {
  ...
  beforeEach(async () => {
    ...
    USD = { code: "USD", asset_type: "", name: "US Dollar", decimal_places: 2 };
    ETH = { code: "ETH", asset_type: "", name: "Ether", decimal_places: 18 };
  ...
  it("excludes hidden currencies from holdings", async () => {
    ...
    const SPAM: Currency = { code: "SPAM", asset_type: "", name: "Spam Token", decimal_places: 18 };
