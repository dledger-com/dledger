/** SQL schema for dledger. Ported from crates/dledger-core/src/schema.rs. */
...
-- Enable foreign keys (WAL not applicable to IndexedDB VFS)
PRAGMA foreign_keys=ON;
`;

/** Plugin key-value storage schema. From src-tauri/src/plugin/storage.rs. */
export const PLUGIN_KV_SCHEMA = `
